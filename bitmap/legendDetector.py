...
class legendDetector:
  ...
  def __init__(self, modelPath):
    self.category_index = label_map_util.create_category_index_from_labelmap('/Users/Jordan/Documents/Imperial/ME4/FYP/Data_Extraction_Project/Python/bitmap/legend_detection/models/research/object_detection/training/labelmap.pbtxt', use_display_name=True)
